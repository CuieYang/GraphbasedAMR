...
embed_path = "C:/codes/AMR0.2v2/src/dict_embed/glove.840B.300d.txt"    #file containing glove embedding
...
resource_folder_path  = "C:/codes/AMR_GPU/databuild_data/"  #os.path.expanduser('~')+"/Data/amr_annotation_r2/"
frame_folder_path = "C:/codes/AMR_GPU/propbank-frames/"  # resource_folder_path+"data/frames/propbank-frames-xml-2016-03-08/"
